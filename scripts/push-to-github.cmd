...
REM
REM Usage (from anywhere — this wrapper auto-cd's to the KOCopilot project root):
REM   path\to\scripts\push-to-github.cmd https://github.com/yourname/kocopilot.git
REM
